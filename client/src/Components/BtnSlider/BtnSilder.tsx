...
export default function BtnSilder() {
  ...
  return (
    ...
    {matchDogs ?     
    <section className="">
      <img src={"congrats.png"} onClick={handleMatch} className='absolute top-0	left-0 w-full h-screen z-50' />
      <div className=' p-10 rounded-2xl	 w-96 h-2/4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-300 h-auto absolute z-50 m-auto '>
    ...
    :""}
    <figcaption className="w-[736px] m-auto px-28 flex place-content-between items-center max-md:w-[100%] px-8 gap-x-3">
