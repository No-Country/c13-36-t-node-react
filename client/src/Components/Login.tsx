...
const Login: React.FC<LoginProps> = ({ setusuario }) => {
  ...
  return (
    <main className="min-h-screen">
      <div className="flex justify-center items-center mt-24 flex-col px-5 py-16 w-[500px] border-2 border-[#000] relative  rounded-md max-sm:w-[100%] max-sm:bg-[#fff] max-sm:py-8 ">
        <img
          src={"avatar.png"}
