    ...
    <main className="flex justify-start flex-col items-center w-[500px] border-2 border-black relative rounded-md max-md:w-[100%] bg-[#fff]">
      ...
      <form className="flex flex-col items-start gap-3 w-[350px]">
        ...
        <div className="relative w-[100%]">
          ...
          />
          <i
            className="fa-solid fa-user absolute right-3 top-[12px]"
            style={{ color: "#333" }}
          ></i>
        </div>
        <label className="font-semibold ml-1 mt-2" htmlFor="emailUser">
        ...
        <label className="font-semibold ml-1 mt-2" htmlFor="phoneUser">
          Telefono
        </label>
        <div className="relative w-[100%]">
          <input
          ...
          />
          <i
            className="fa-solid fa-phone absolute right-3 top-[12px]"
            style={{ color: "#333" }}
          ></i>
        </div>
