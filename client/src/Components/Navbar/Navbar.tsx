  ...
  return (
    <nav className="relative  w-full flex bg-[#B186F1] place-content-between items-center mb-2 py-2 px-4 sticky top-0 z-10">
      ...
      {usuario !== undefined ? (
        ...
        <>
          <ul
            className={`flex gap-10 justify-center items-center max-md:absolute max-md:flex-col max-md:bg-[#B186F1] max-md:top-[6.5rem] max-md:right-0 max-md:w-60 max-md:p-8 max-md:rounded-xl max-md:${
